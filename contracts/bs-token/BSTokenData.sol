...
contract BSTokenData is Stoppable {
    ...
    function setBalance(address account, uint256 balance) stopInEmergency {
    ...
    function setTotalSupply(uint256 aTotalSupply) stopInEmergency {
    ...
    function setAllowance(address account, address spender, uint256 amount) stopInEmergency {
    ...
    function freezeAccount(address account, bool freeze) {
    ...
    function freezeAccountForLogic(address account, bool freeze) stopInEmergency {
